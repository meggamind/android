...
public class Keypad extends Dialog{
    ...
    // fetches and saves the views for all the keypad keys and the main keypad window
    private void findViews(){
        keypad = findViewById(R.id.keyboard);
    ...
    // Checks whether the given number is valid for the current position
    ...
    // return the number selected to the calling activity
    // Puzzle.setSeelctedTile() method to chnage the puzzle's current tile.
    // dismiss call terminates the keypad dialog box
